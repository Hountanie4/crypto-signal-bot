...
CHAT_ID   = "2020862907"
CHECK_INTERVAL = 300  # seconds (5 mins)
...
def main():
    ...
    alerted = {}  # prevent duplicate signals
    ...
    while True:
        for symbol in COINS:
            ...
            if signal:
                ...
                # Only alert once every 4 hours per coin per direction
